...
<head>
    ...
    <!-- Favicons Icon -->
	<link rel="shortcut icon" type="image/x-icon" href="/public/uploads/favicon.png" />
    
    <!-- Title -->
	<title>404 Not Found</title>
    
    <!-- Stylesheets -->
    <link rel="stylesheet" type="text/css" href="/public/layout/mobile_old/assets/css/style.css">
            ...
            <div class="container">
                <div class="header-content">
                    <div class="left-content">
                        ...
                        <h5 class="mb-0 ms-2 text-nowrap">Back</h5>
                    </div>
...
<!--**********************************
    Scripts
***********************************-->
<script src="/public/layout/mobile_old/assets/js/jquery.js"></script>
<script src="/public/layout/mobile_old/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="/public/layout/mobile_old/assets/js/settings.js"></script>
<script src="/public/layout/mobile_old/assets/js/custom.js"></script>
</body>
</html>