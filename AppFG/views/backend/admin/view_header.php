            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <?php if (in_array($this->session->userdata('role'), ['Superadmin','Admin'])) : ?>
                            <li class="treeview <?php if (($class_name == 'backend/admin/contact')) {
                                                    echo 'active';
                                                } ?>" id="7">
                                <a href="<?php echo base_url(); ?>backend/admin/contact">
                                    <i class="fa fa-history"></i> <span>Kontakt Nachrichten</span>
                                </a>
                            </li>
                        <?php endif; ?>
