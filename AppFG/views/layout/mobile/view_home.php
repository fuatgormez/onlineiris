...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/layout/mobile/styles/bootstrap.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/layout/mobile/styles/style.css">
<link href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700,800,900|Roboto:300,300i,400,400i,500,500i,700,700i,900,900i&amp;display=swap" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/layout/mobile/fonts/css/fontawesome-all.min.css">    
<link rel="manifest" href="<?php echo base_url();?>public/layout/mobile/_manifest.json" data-pwa-version="set_in_manifest_and_pwa_js">
<link rel="apple-touch-icon" sizes="180x180" href="<?php echo base_url();?>public/layout/mobile/app/icons/icon-192x192.png">
</head>
...
<div id="page">
    ...
    <div class="page-content">
        ...
        <div class="page-title page-title-large">
            ...
            <a href="#" data-menu="menu-main" class="bg-fade-highlight-light shadow-xl preload-img" data-src="<?php echo base_url();?>public/layout/mobile/images/avatars/5s.png"></a>
        </div>
        <div class="card header-card shape-rounded" data-card-height="210">
            <div class="card-overlay bg-highlight opacity-95"></div>
            <div class="card-overlay dark-mode-tint"></div>
            <div class="card-bg preload-img" data-src="<?php echo base_url();?>public/layout/mobile/images/pictures/20s.jpg"></div>
        </div>
        ...
        <div class="card preload-img" data-src="<?php echo base_url();?>public/layout/mobile/images/pictures/20s.jpg">
            <div class="card-body">
        ...
        <div class="card card-style preload-img" data-src="<?php echo base_url();?>public/layout/mobile/images/pictures/20s.jpg" data-card-height="350">
                    ...
                    <div class="splide__list">
                        <div class="splide__slide">
                            <div class="text-center">
                                <img src="<?php echo base_url();?>public/layout/mobile/images/avatars/1s.png" width="55" height="55" class="rounded-xl shadow-l gradient-blue">
                                <p>Jane</p>
                            </div>     
                        </div>
                        <div class="splide__slide">
                            <div class="text-center">
                                <img src="<?php echo base_url();?>public/layout/mobile/images/avatars/2s.png" width="55" height="55" class="rounded-xl shadow-l gradient-red">
                                <p>Craig</p>
                            </div>  
                        </div>
                        <div class="splide__slide">
                            <div class="text-center">
                                <img src="<?php echo base_url();?>public/layout/mobile/images/avatars/1s.png" width="55" height="55" class="rounded-xl shadow-l gradient-green">
                                <p>Jane</p>
                            </div>     
                        </div>
                        <div class="splide__slide">
                            <div class="text-center">
                                <img src="<?php echo base_url();?>public/layout/mobile/images/avatars/2s.png" width="55" height="55" class="rounded-xl shadow-l gradient-brown">
                                <p>Craig</p>
                            </div>  
                        </div>
                    </div>
    ...
    <div id="menu-install-pwa-android" class="menu menu-box-bottom menu-box-detached rounded-l"
        ...
        <div class="boxed-text-l mt-4">
            <img class="rounded-l mb-3" src="<?php echo base_url();?>public/layout/mobile/app/icons/icon-128x128.png" alt="img" width="90">
...
<script type="text/javascript" src="<?php echo base_url();?>public/layout/mobile/scripts/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>public/layout/mobile/scripts/custom.js"></script>
</body>
